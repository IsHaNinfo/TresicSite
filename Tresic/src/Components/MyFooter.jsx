...
const MyFooter = () => {
  ...
  <div className="p-16 rounded-md mb-2 sm:mb-0 sm:mr-16">
    <a href="" className="text font-semibold flex items-center justify-center space-x-3">
      <img src={Logo} alt="" className="w-12 inline-block" />
      <span className="text-brandPrimary text-2xl">TRESIC TECHNOLOGY</span>
    </a>
    <p className="text-brandPrimary font-semibold ml-4">"Imagination come True"</p>
    <div className="flex space-x-16 mt-4 sm:mt-8 sm:justify-center">
      <a href="#" className="text-brandPrimary text-3xl"><BsFacebook /></a>
      <a href="#" className="text-brandPrimary text-3xl"><BsInstagram /></a>
      <a href="#" className="text-brandPrimary text-3xl"><BsLinkedin /></a>
    </div>
  </div>
